### Code credit to https://github.com/dwadden/dygiepp/blob/master/scripts/data/shared/collate.py
...
def get_args(args=None):
    ...
    parser.add_argument("--max_spans_per_doc", type=int, default=5000,
...
class CollateRunner:
    ...
    def run(self):
        ...
        fold_names = [f.split('.')[0] for f in os.listdir(self.input_directory) if f.endswith(self.file_extension)]
